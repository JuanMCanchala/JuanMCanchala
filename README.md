...
| [**End2End**](https://github.com/JuanMCanchala/End2End)                             | Team of AI agents that handles a company's customers end to end over WhatsApp and Telegram: qualifies the lead, builds the PDF proposal, books the Calendly meeting and follows up — with human takeover. | Next.js, Claude, Supabase, Twilio             |
| [**Sentinel**](https://github.com/JuanMCanchala/sentinel)                  | Real-time, zero-shot incident detection on video (theft, aggression, falls). Switching domains means changing a YAML file, not retraining a model.                                                     | Python, VLMs, Convex, TypeScript    |
