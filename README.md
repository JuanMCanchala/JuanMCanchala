...
| [**Argos**](https://github.com/JuanMCanchala/argos)                  | Real-time, zero-shot incident detection on video (theft, aggression, falls). Switching domains means changing a YAML file, not retraining a model.                                                     | Python, VLMs, Convex, TypeScript    |
